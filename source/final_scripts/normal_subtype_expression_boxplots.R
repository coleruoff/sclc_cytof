...
# 4 "subtypes" detected in normal cells
################################################################################
...
# Save figures
################################################################################
tiff(glue("figures/normal_subtype_tf_expression_boxplot.tiff"), width=160,height=160, units = "mm", res=1000)
print(p1)
dev.off()

tiff(glue("figures/normal_subtype_expression_boxplot.tiff"), width=260,height=260, units = "mm", res=1000)
print(p2)
dev.off()
