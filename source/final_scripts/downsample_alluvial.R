...
p3
tiff("figures/downsampled_subtype_treatment_status_or_results.tiff", width=100,height=200, units = "mm", res=600)
print(p3)
dev.off()
...
p4
tiff("figures/downsampled_subtype_tarla_or_results.tiff", width=100, height=200, units = "mm", res=600)
print(p4)
dev.off()
