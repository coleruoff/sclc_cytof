...
jpeg("figures/treatment_status_no_tarla_cluster.jpg", width=120,height=100, units = "mm", res=1000)
print(p1)
dev.off()


jpeg("figures/treatment_status_no_tarla_naive_vs_treated_cluster.jpg", width=180,height=100, units = "mm", res=1000)
print(p2)
dev.off()
...
jpeg("figures/treatment_status_no_tarla_cluster_diff_abundance_barplots.jpg", width=120,height=100, units = "mm", res=1000)
print(p1)
dev.off()
################################################################################
...
jpeg("figures/treatment_status_no_tarla_subtype_diff_abundance_barplots.jpg", width=120,height=100, units = "mm", res=1000)
print(p1)
dev.off()
################################################################################
...
jpeg(glue("figures/treatment_status_no_tarla_cluster_{metric_to_use}_de_all.jpg"), width=140,height=100, units = "mm", res=1000)
print(p2)
dev.off()
